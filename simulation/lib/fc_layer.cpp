...
void fc_layer(float *fc_input, float *fc_output, float *fc_weights, float *fc_biases, const uint16_t input_size, const uint16_t fc_output_size, const uint16_t fc_batch_size) {
